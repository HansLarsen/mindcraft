...
export class Prompter {
    constructor(agent, fp) {
        ...
        [this.chat_model, this.code_model, this.vision_model] = ModelFactory.createModels(this.profile.model, this.profile.code_model, this.profile.vision_model)
        this.embedding_model = ModelFactory.createEmbeddingModel(this.profile.embedding, this.profile.model)
